...
const Cart = (props) => {
  var { cartData ,downQuantity,upQuantity,deleteItem,getInfCus,customer,checkoutBS} = props;
  ...
  return (
    <section>
      <div className="row">
        ...
        {/*Grid column*/}
        {/*Grid column*/}
        <Checkout getInfCus={getInfCus} customer={customer} price={sumCart} checkoutBS={checkoutBS}/>
        {/*Grid column*/}
      </div>
      {/* Grid row */}
    </section>
